...
Usage:
    python evaluation/code/evaluation_speech_models.py --models whisper:base,wav2vec2:xlsr-53-french
"""
...
class SpeechAPIEvaluator:
    ...
    def load_test_dataset(self, data_path: str = "cv-corpus-21.0-delta-2025-03-14-fr/cv-corpus-21.0-delta-2025-03-14/fr") -> List[Dict]:
        try:
